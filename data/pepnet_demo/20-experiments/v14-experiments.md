...
|  8   | ots012_plebig         |   0.12   |   0.771514   |   0.724105   |   +2.84pp   |     —      |
|  9   | ots012_wide_dropout03 |   0.12   |   0.771586   |   0.723583   |   +2.79pp   |     —      |
...
**其他已验证方向全部证否：** dropout（ots≥0.12 冗余）、CVR tower 扩宽（−0.18pp）、PLE expert 容量翻 4x（−0.04pp 等同基线）、weight decay（零）、ctcvr（中性偏负）、梯度隔离/手术/自适应加权（全部负或中性）。
...
|  9   | **ots012_wide_dropout03** | **0.12** | 0.717040 (+0.05pp) | 0.704494 (+0.01pp) | 1.25pp (+0.03pp) |   0.771586 (+2.33pp)   |   0.723583 (+2.79pp)   |            —            | 0.470593 |
|  10  | **ots012_wide**           | **0.12** | 0.717026 (+0.05pp) | 0.703987 (−0.04pp) | 1.27pp (+0.05pp) |   0.770405 (+2.21pp)   |   0.722696 (+2.70pp)   |            —            | 0.470840 |
|  11  | **ots010**                | **0.10** | 0.716789 (+0.02pp) | 0.704269 (−0.01pp) | 1.25pp (+0.03pp) | **0.769227 (+2.10pp)** | **0.721169 (+2.54pp)** |    4.81pp (−0.44pp)     | 0.475246 |
|  12  | **ots009**                | **0.09** | 0.716805 (+0.03pp) | 0.704278 (−0.01pp) | 1.25pp (+0.03pp) | **0.768202 (+1.99pp)** | **0.719989 (+2.43pp)** |    4.82pp (−0.43pp)     | 0.477601 |
|  13  | **ots008**                | **0.08** | 0.716910 (+0.04pp) | 0.704051 (−0.03pp) | 1.29pp (+0.07pp) | **0.766609 (+1.83pp)** | **0.718024 (+2.23pp)** |    4.86pp (−0.39pp)     | 0.479808 |
|  14  | **ots007**                | **0.07** | 0.716907 (+0.04pp) | 0.704555 (+0.02pp) | 1.24pp (+0.02pp) | **0.765117 (+1.68pp)** | **0.716325 (+2.06pp)** |    4.88pp (−0.37pp)     | 0.482036 |
|  15  | **ots006**                | **0.06** | 0.716794 (+0.03pp) | 0.704602 (+0.02pp) | 1.22pp (0.00pp)  | **0.763227 (+1.50pp)** | **0.713890 (+1.82pp)** |    4.93pp (−0.32pp)     | 0.484197 |
|  16  | **ots005**                |   0.05   | 0.716913 (+0.04pp) | 0.704180 (−0.02pp) | 1.27pp (+0.06pp) | **0.761379 (+1.31pp)** | **0.711754 (+1.60pp)** |    4.96pp (−0.29pp)     | 0.486131 |
|  17  | **ots004**                |   0.04   | 0.716860 (+0.03pp) | 0.704377 (+0.00pp) | 1.25pp (+0.03pp) | **0.759201 (+1.09pp)** | **0.709396 (+1.37pp)** |    4.98pp (−0.27pp)     | 0.488148 |
|  18  | **ots003**                |   0.03   | 0.716871 (+0.03pp) | 0.704479 (+0.01pp) | 1.24pp (+0.02pp) | **0.756928 (+0.87pp)** | **0.706061 (+1.03pp)** |    5.09pp (−0.17pp)     | 0.489879 |
|  19  | **ots002_dropout03**      |   0.02   | 0.716760 (+0.02pp) | 0.704256 (−0.01pp) | 1.25pp (+0.03pp) | **0.756139 (+0.79pp)** | **0.705148 (+0.94pp)** |    5.10pp (−0.16pp)     |    —     |
|  20  | **ots002**                |   0.02   | 0.716809 (+0.03pp) | 0.704213 (−0.02pp) | 1.26pp (+0.04pp) | **0.754525 (+0.63pp)** | **0.703538 (+0.78pp)** |    5.10pp (−0.16pp)     |    —     |
|  21  | **ots002_adamw**          |   0.02   | 0.716850 (+0.03pp) | 0.704170 (−0.02pp) | 1.27pp (+0.05pp) | **0.754614 (+0.63pp)** | **0.703467 (+0.77pp)** |    5.11pp (−0.14pp)     | 0.491437 |
|  22  | **dropout03**             |   0.01   | 0.716781 (+0.02pp) | 0.703957 (−0.04pp) | 1.28pp (+0.07pp) | **0.752831 (+0.46pp)** | **0.701893 (+0.62pp)** |    5.09pp (−0.16pp)     | 0.492900 |
|  23  | **config_c** (v14 BL)     |   0.01   | 0.716686 (+0.01pp) | 0.704301 (−0.01pp) | 1.24pp (+0.02pp) | **0.751547 (+0.33pp)** | **0.699560 (+0.38pp)** |    5.20pp (−0.06pp)     | 0.493054 |
|  24  | **ots0005**               |  0.005   | 0.716735 (+0.02pp) | 0.704386 (+0.00pp) | 1.23pp (+0.02pp) |   0.748989 (+0.07pp)   |   0.696614 (+0.09pp)   |    5.24pp (−0.02pp)     | 0.493725 |
|  25  | **ctcvr** (ESMM)          |    —     | 0.716570 (+0.00pp) | 0.703671 (−0.07pp) | 1.29pp (+0.07pp) |   0.750125 (+0.19pp)   |   0.698665 (+0.29pp)   |    5.14pp (−0.11pp)     |   N/A    |
...
## 七、剩余方向：Round 1 config-only 实验（2026-06-28 启动）

**背景：** ots 全扫完结（+4.56pp max），PLE 容量（−0.04pp）、tower 宽度（−0.18pp）、dropout（冗余 at ots≥0.12）、wd（零）、ctcvr（中性）全部证否。
