...
|  8   | **ots010**         | **0.10** | **0.769227** | **0.721169** | **+2.54pp** | **4.81pp** |
|  9   | **ots009**         | **0.09** | **0.768202** | **0.719989** | **+2.43pp** | **4.82pp** |
|  10  | **ots008**         | **0.08** | **0.766609** | **0.718024** | **+2.23pp** | **4.86pp** |
|  11  | **ots007**         | **0.07** | **0.765117** | **0.716325** | **+2.06pp** | **4.88pp** |
|  12  | **ots006**         | **0.06** | **0.763227** | **0.713890** | **+1.82pp** | **4.93pp** |
|  13  | ots005             |   0.05   |   0.761379   |   0.711754   |   +1.60pp   |   4.96pp   |
|  14  | ots004             |   0.04   |   0.759201   |   0.709396   |   +1.37pp   |   4.98pp   |
|  15  | ots003             |   0.03   |   0.756928   |   0.706061   |   +1.03pp   |   5.09pp   |
|  16  | ots002_dropout03   |   0.02   |   0.756139   |   0.705148   |   +0.94pp   |   5.10pp   |
|  17  | ots002             |   0.02   |   0.754525   |   0.703538   |   +0.78pp   |   5.10pp   |
|  18  | dropout03          |   0.01   |   0.752831   |   0.701893   |   +0.62pp   |   5.09pp   |
|  19  | config_c (v14 ref) |   0.01   |   0.751547   |   0.699560   |   +0.38pp   |   5.20pp   |
|  20  | ots0005            |  0.005   |   0.748989   |   0.696614   |   +0.09pp   |   5.24pp   |
|  21  | ctcvr (ESMM)       |    —     |   0.750125   |   0.698665   |   +0.29pp   |   5.14pp   |
...
| 实验             | ots  |    d    | GAUC_cvr | vs config_c |
| :--------------- | :--: | :-----: | :------: | :---------: |
| config_c         | 0.01 |   0.1   | 0.699560 |      —      |
| dropout03        | 0.01 | **0.3** | 0.701893 |   +0.23pp   |
| ots002           | 0.02 |   0.1   | 0.703538 |   +0.40pp   |
| ots002_dropout03 | 0.02 | **0.3** | 0.705148 |   +0.56pp   |

dropout 和 ots 有弱叠加效应：ots=0.01 时 d=0.1→0.3 增益 +0.23pp，ots=0.02 时 +0.16pp。但 ots 本身的增益远大于 dropout 调整。

### 4.4 饱和分析（2026-06-28 完结）
...
|  8   | **ots010**            | **0.10** | 0.716789 (+0.02pp) | 0.704269 (−0.01pp) | 1.25pp (+0.03pp) | **0.769227 (+2.10pp)** | **0.721169 (+2.54pp)** |    4.81pp (−0.44pp)     | 0.475246 |
|  9   | **ots009**            | **0.09** | 0.716805 (+0.03pp) | 0.704278 (−0.01pp) | 1.25pp (+0.03pp) | **0.768202 (+1.99pp)** | **0.719989 (+2.43pp)** |    4.82pp (−0.43pp)     | 0.477601 |
|  10  | **ots008**            | **0.08** | 0.716910 (+0.04pp) | 0.704051 (−0.03pp) | 1.29pp (+0.07pp) | **0.766609 (+1.83pp)** | **0.718024 (+2.23pp)** |    4.86pp (−0.39pp)     | 0.479808 |
|  11  | **ots007**            | **0.07** | 0.716907 (+0.04pp) | 0.704555 (+0.02pp) | 1.24pp (+0.02pp) | **0.765117 (+1.68pp)** | **0.716325 (+2.06pp)** |    4.88pp (−0.37pp)     | 0.482036 |
|  12  | **ots006**            | **0.06** | 0.716794 (+0.03pp) | 0.704602 (+0.02pp) | 1.22pp (0.00pp)  | **0.763227 (+1.50pp)** | **0.713890 (+1.82pp)** |    4.93pp (−0.32pp)     | 0.484197 |
|  13  | **ots005**            |   0.05   | 0.716913 (+0.04pp) | 0.704180 (−0.02pp) | 1.27pp (+0.06pp) | **0.761379 (+1.31pp)** | **0.711754 (+1.60pp)** |    4.96pp (−0.29pp)     | 0.486131 |
|  14  | **ots004**            |   0.04   | 0.716860 (+0.03pp) | 0.704377 (+0.00pp) | 1.25pp (+0.03pp) | **0.759201 (+1.09pp)** | **0.709396 (+1.37pp)** |    4.98pp (−0.27pp)     | 0.488148 |
|  15  | **ots003**            |   0.03   | 0.716871 (+0.03pp) | 0.704479 (+0.01pp) | 1.24pp (+0.02pp) | **0.756928 (+0.87pp)** | **0.706061 (+1.03pp)** |    5.09pp (−0.17pp)     | 0.489879 |
|  16  | **ots002_dropout03**  |   0.02   | 0.716760 (+0.02pp) | 0.704256 (−0.01pp) | 1.25pp (+0.03pp) | **0.756139 (+0.79pp)** | **0.705148 (+0.94pp)** |    5.10pp (−0.16pp)     |    —     |
|  17  | **ots002**            |   0.02   | 0.716809 (+0.03pp) | 0.704213 (−0.02pp) | 1.26pp (+0.04pp) | **0.754525 (+0.63pp)** | **0.703538 (+0.78pp)** |    5.10pp (−0.16pp)     |    —     |
|  18  | **ots002_adamw**      |   0.02   | 0.716850 (+0.03pp) | 0.704170 (−0.02pp) | 1.27pp (+0.05pp) | **0.754614 (+0.63pp)** | **0.703467 (+0.77pp)** |    5.11pp (−0.14pp)     | 0.491437 |
|  19  | **dropout03**         |   0.01   | 0.716781 (+0.02pp) | 0.703957 (−0.04pp) | 1.28pp (+0.07pp) | **0.752831 (+0.46pp)** | **0.701893 (+0.62pp)** |    5.09pp (−0.16pp)     | 0.492900 |
|  20  | **config_c** (v14 BL) |   0.01   | 0.716686 (+0.01pp) | 0.704301 (−0.01pp) | 1.24pp (+0.02pp) | **0.751547 (+0.33pp)** | **0.699560 (+0.38pp)** |    5.20pp (−0.06pp)     | 0.493054 |
|  21  | **ots0005**           |  0.005   | 0.716735 (+0.02pp) | 0.704386 (+0.00pp) | 1.23pp (+0.02pp) |   0.748989 (+0.07pp)   |   0.696614 (+0.09pp)   |    5.24pp (−0.02pp)     | 0.493725 |
|  22  | **ctcvr** (ESMM)      |    —     | 0.716570 (+0.00pp) | 0.703671 (−0.07pp) | 1.29pp (+0.07pp) |   0.750125 (+0.19pp)   |   0.698665 (+0.29pp)   |    5.14pp (−0.11pp)     |   N/A    |
