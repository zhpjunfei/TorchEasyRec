...
fg_task = run_on_odps.FgTask(
    "feature_mall_home_flow_2604_ctrcvr_sorter_v2_training_set",
    "home_flow_2604_ctrcvr_sorter_config_pyfg_encoded_v1c",
    "home_flow_2604_ctrcvr_sorter_config_fg_v1c.json",
