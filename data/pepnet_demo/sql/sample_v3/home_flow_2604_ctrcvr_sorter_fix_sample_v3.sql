...
INSERT OVERWRITE TABLE feature_mall_home_flow_2604_ctrcvr_sorter_v3_training_set PARTITION (dt = '${bdp.system.bizdate}')
...
LEFT JOIN   (
                SELECT  *
                FROM    home_flow_2604_mmb_id_all_seq_feat_v3
                WHERE   dt = '${bdp.system.bizdate}'
            ) sq56
