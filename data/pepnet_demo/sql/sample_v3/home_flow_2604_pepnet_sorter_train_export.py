...
dlc submit pytorchjob \
    --name=home_flow_2604_sorter_train_export_afp_fw \
    --command='set -e
        ...
        -m tzrec.train_eval \
        --pipeline_config_path /mnt/data/deploy/home_flow_2604_ctrcvr_sorter_v1/home_flow_2604_v15_afp.config \
        --train_input_path odps://mmb_sage/tables/home_flow_2604_ctrcvr_sorter_config_pyfg_encoded_shuffled_60d_v3/dt=${train_ymd} \
        --model_dir /mnt/data/deploy/home_flow_2604_ctrcvr_sorter_v1/pepnet_afp_fw/${train_ymd}
        ...
        --nnodes=$WORLD_SIZE --nproc-per-node=$NPROC_PER_NODE --node_rank=$RANK \
        -m tzrec.export \
        --pipeline_config_path /mnt/data/deploy/home_flow_2604_ctrcvr_sorter_v1/pepnet_afp_fw/${train_ymd}/pipeline.config \
        --export_dir /mnt/data/deploy/home_flow_2604_ctrcvr_sorter_v1/pepnet_afp_fw/${train_ymd}/export/final_with_fg' \
